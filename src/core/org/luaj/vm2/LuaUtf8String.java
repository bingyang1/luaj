...
public class LuaUtf8String extends LuaValue {
    ...
    public static LuaUtf8String valueOfString(String string) {
        ...
        return valueUsing(c, 0, c.length);
    }
    ...
    private static LuaUtf8String valueFromCopy(char[] bytes, int off, int len) {
     ...
     */
    static public LuaUtf8String valueUsing(char[] bytes, int off, int len) {
    ...
    public LuaString optstring(LuaString defval) {
        return toLuaString(m_bytes,m_offset,m_length);
    }
    ...
    public static LuaString toLuaString(char[] bytes, int off, int len) {
        char[] b = new char[len];
        for ( int i=0; i<len; i++ )
            b[i] = bytes[i + off];
        byte[] b2 = new byte[lengthAsUtf8(b)];
    ...
    private boolean byteseq(char[] bytes, int off, int len) {
     ...
     * @see #encodeToUtf8(char[], int, char[], int)
     * @see #isValidUtf8()
     */
